		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<tr role="row">
                        <th><?php echo $this->Paginator->sort('SmsTemplate.type', 'Type', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('SmsTemplate.about', 'About', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('SmsTemplate.message', 'message', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('SmsTemplate.created', 'Created', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('SmsTemplate.status', 'Status', array('escape' => false)); ?></th>
                        <th>Action</th>
                    </tr>
</thead>
<tbody id="table_rows">
