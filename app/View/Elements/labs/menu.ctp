...
<a href="#"> <i class="fa fa-calculator"></i> <span>Make/Model/Engine</span> <i class="fa fa-angle-left pull-right"></i> </a>
<ul class="treeview-menu">
...
<li><a href="<?php echo SITEURL."lab/labs/tuning_box";?>"><i class="fa fa-circle-o"></i>All</a></li>
            ...
            <li class="treeview" id="pro_settings">
              <a href="#"><i class="fa fa-shopping-cart"></i> <span>Exhaust Product</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
...
<li class="treeview" id="ext_pro">
        <a href="#"><i class="fa fa-qrcode"></i> <span>Extra Product</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
