 ...
 $order_status = $this->Lab->order_status();
                    ...
                    if (!empty($data)) {
                        foreach ($data as $list) { ?>
                            <tr class="odd gradeX">
                                <td class="center gnTxt"><a href="<?php echo SITEURL."lab/labs/view_message/".$list['Order']['id'];?>" title="Send Message"> <?php echo $list['Order']['order_number']; ?></a>
                                <?php if(isset($list['OrderMessages']) && !empty($list['OrderMessages'])){ echo "<span class='n_m'>(NEW)<span>";}?>
                                </td>
                                ...
                                <td class="center"> <?php echo @$list['World']['name']; ?> </td>
