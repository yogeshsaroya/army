<?php $bg_img = $this->Lab->getBgImgName('dyno');?>
...
.bg-army-bx{min-height:600px;min-height:100vh;padding:100px 0;background:url(<?php echo SITEURL."cdn/bg_image/".$bg_img;?>) no-repeat center center;background-size:cover;letter-spacing:.3px}
...
#bg-welcome.sponser-form h2 {
    ...
    margin: 0 -50px;
    line-height: 1;
    text-shadow: 3px 8px 3px rgba(0, 0, 0, 0.55);
...
#bg-welcome.sponser-form h2:after {
    background: url(../v/text-bg.png) no-repeat right bottom;
    position: absolute;
    z-index: -5;
    right: -54px;
    bottom: -16px;
...
@media (max-width:580px){
    ...
    font-size: 30px;  
    margin: 0 0;    
    text-shadow: 1px 5px 2px rgba(0, 0, 0, 0.55);
	margin: 0 -30px;   
}
...
<div id="bg-welcome" class="bg-army-bx sponser-form">
  <div class="container">
   <div class="col-sm-12">
    <div class="head-ings">
    <h2>You dyno,
      <span class="red-clr">we pay you!</span>
      <span>+ A free T-SHIRT</span></h2>    
    </div>
 <!----start form---->
