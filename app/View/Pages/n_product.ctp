...
<script type="application/ld+json">
    {
      ...
      "review": {
        ...
        "author": {"@type": "Organization","name": "Armytrix - Automotive Weaponized"}
      },
      "aggregateRating": {
...
.main_header{border-bottom:medium none!important}#photogallery{text-align:left}.product-page-heading{text-align:center;padding:20px 0}.product-page-heading h1{font-size:54px;font-weight:800;color:#000;text-align:center;padding-bottom:20px}.product-page-heading h2{text-transform:none;line-height:40px}.product-page-heading h3{font-size:22px;font-weight:800;color:FF0000;text-align:center;text-transform:none}.lslide img{width:100%}.slider-below-text{font-size:24px;font-weight:800;color:#000;text-align:center}.slider-below-text span{font-size:58px;font-weight:800;color:red;display:block;padding:20px 1px 1px}.page-main-text{clear:both;padding:40px 0}.hand-img img{width:100%}.body-button a{color:#fff;font-size:24px;font-style:italic;position:fixed;left:-30px;font-weight:700;display:block;padding:20px;z-index:11;-ms-transform:rotate(90deg);-webkit-transform:rotate(90deg);transform:rotate(90deg);border-radius:5px 5px 0 0;-moz-border-radius:5px 5px 0 0;-webkit-border-radius:5px 5px 0 0}.body-button a.enquiry{background-color:#000;top:230px;color:#fff}.body-button a.enquiry:hover{background-color:#000;color:#fff}.body-button a.m4{background-color:#000;top:430px;left:-90px}.body-button a.m4:hover{background-color:#000;color:#fff}.car-list{height:97%;overflow:scroll;overflow-x:hidden;background-color:#eeedeb;padding:10px;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px}.car-list .car{margin-bottom:10px}.car-list .car img{width:100%}a.popup-youtube{position:relative;display:block}a.popup-youtube img.youtube-icon{max-width:50px;max-height:50px;margin:auto;display:block;position:absolute;top:0;bottom:0;left:0;right:0}#photogallery .row{width:auto}@media only screen and (max-width:767px){.body-button{text-align:center;position:fixed;bottom:5px;width:100%;z-index:111}.body-button a{padding:7px 16px;font-size:16px;text-align:center;display:inline-block;position:static;transform:none;-moz-transform:none;-webkit-transform:none;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px}.body-button a.enquiry{top:inherit;left:inherit}.body-button a.m4{top:inherit;left:inherit}}.sub-menu li a{text-decoration:none}.back-to-top{background:none;margin:0;position:fixed;bottom:0;right:0;width:70px;height:70px;z-index:100;display:none;text-decoration:none;color:#fff;background-color:#000}.back-to-top i{font-size:60px}
...
.new-pro-drdwn button:hover{background-color:#dedcdc!important;}
.new-pro-drdwn ul{position:absolute;top:100%;left:0;z-index:1000;display:none;float:left;min-width:160px;width:100%; padding:5px 0;margin:2px 0 0;list-style:none;font-size:14px;background-color:#fff;border:1px solid #ccc;border:1px solid rgba(0,0,0,.15);z-index:555}
...
<link rel="stylesheet" href="<?php echo SITEURL;?>v_4/css/new_productpage.css" type="text/css" media="all" />
...
<?php /*?>
<div class="arw-close" id="cls_lng_arr"><img loading="lazy" src="<?php echo SITEURL;?>product-detail/arow-army_close.png" alt=""/></div>
...
<li role="presentation"><a href="#data" aria-controls="data" role="tab" data-toggle="tab">Sound</a></li>
<li role="presentation"><a href="#about" aria-controls="about" role="tab" data-toggle="tab">About</a></li>

</ul>
<div class="tab-content">
<div role="tabpanel" class="tab-pane active" id="products"></div>
<div role="tabpanel" class="tab-pane overlay" id="about"> <p><?php echo nl2br ($data['ItemDetail']['about_details']);?></p> </div>

<div role="tabpanel" class="tab-pane overlay" id="data"> <div id="sound_arm">

<?php  if ( file_exists("army_sound/".$data['ItemDetail']['url'].".mp3") ) { ?>

<style>
div#tab-data .tab-content .tab-pane { padding: 15px 15px; }

#sound_arm .hr_arm{margin-bottom:20px;border-top:2px solid #fff}
#b1{border-bottom:2px solid #fff; margin-top: 15px !important;}
#b1,#b2{text-align: center;}
#sound_arm p {text-transform: uppercase;}
.play_img{background-image:url(../v_4/play.png);background-color:rgba(0,0,0,0);border:none;height:64px;width:64px;background-repeat:no-repeat;background-size:cover}
.pause_img{background-image:url(../v_4/pause.png);background-color:rgba(0,0,0,0);border:none;height:64px;width:64px;background-repeat:no-repeat;background-size:cover}

#b2 p, #b1 p { font-size: 14px !important; margin-top: 10px;}


</style>


<audio id="myAudio"> <source src="<?php echo SITEURL."army_sound/".$data['ItemDetail']['url'];?>.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>
<audio id="myAudio1"> <source src="<?php echo SITEURL."army_sound/".$data['ItemDetail']['url'];?>_full.mp3" type="audio/mpeg"> Your browser does not support the audio element. </audio>

<div class="col-sm-6" id="b1">  <button id="playAudio" type="button" class="play_img" aria-hidden="true"></button> <p>Stock Exhaust</p> </div>
<div class="col-sm-6" id="b2">  <button id="playAudio1" type="button" class="play_img" aria-hidden="true"></button> <p>Armytrix Full Exhaust</p> </div>
<div class="clearfix"></div>

<script>
var audio = document.getElementById("myAudio");
var audio1 = document.getElementById("myAudio1");
var b1 = document.getElementById("playAudio");
var b2 = document.getElementById("playAudio1");
document.getElementById("playAudio").addEventListener("click", function(){ audio1.pause(); b2.className = "play_img"; if(this.className == 'pause_img'){ this.className = "play_img"; audio.pause(); }else{ this.className = "pause_img"; audio.play(); } });
document.getElementById("playAudio1").addEventListener("click", function(){ audio.pause(); b1.className = "play_img"; if(this.className == 'pause_img'){ this.className = "play_img"; audio1.pause(); }else{ this.className = "pause_img"; audio1.play(); } });

audio.addEventListener("ended", function(e){ b1.className = "play_img"; }, false);
audio1.addEventListener("ended", function(e){ b2.className = "play_img"; }, false);
</script>
<?php }?>
...
<?php /*?>
<div role="tabpanel" class="tab-pane overlay" id="data"> <h3 class="text-center">TECHNICAL DATA</h3> <div class="overlay-x-scroll"><?php echo $data['ItemDetail']['data_details'];?></div></div>
<?php */?>
</div>
</div>
<?php }?>	          
...
<?php /*?><h3 class="mid-txt-arm-5"><?php echo $data['ItemDetail']['name'];?></h3> <?php */?>
...
if(isset($sArr) && !empty($sArr)){
    foreach ($sArr as $sList){
          ...
          echo '<li data-thumb="'.$th.'"><img loading="lazy" src="'.$main.'" alt="'.$sList['Library']['alt'].'" title="'.$sList['Library']['title'].'"/></li>';
       }}?>
              </ul>
            </div>
          </div>
...
<style>
#sound_arm1111button{background:none;border:none;font-size:50pt;color:#fff}
#sound_arm .hr_arm{margin-bottom:20px;border-top:2px solid #fff}
#b1{border-right:2px solid #fff}
#sound_arm p {text-transform: uppercase;}
.play_img{background-image:url(../v_4/play.png);background-color:rgba(0,0,0,0);border:none;height:64px;width:64px;background-repeat:no-repeat;background-size:cover}
.pause_img{background-image:url(../v_4/pause.png);background-color:rgba(0,0,0,0);border:none;height:64px;width:64px;background-repeat:no-repeat;background-size:cover}
...
#sound_arm {
	...
	<div class="overlay-x-scroll1" id="sound_arm">
...
<?php }?>	
<h1><?php echo $data['ItemDetail']['name'];?> valvetronic exhaust system</h1>
...
<br>
<div class="mail-bx-up"><?php echo $this->Lab->getTeetLang(7,$lngtext);?> <a href="mailto:inquiry@armytrix.com">inquiry@armytrix.com</a></div>
<br>
...
<div id="custom-content" class="white-popup-block1" style="display: none">
<div>
<div class="rows">
...
<div class="col-md-12 form-group"><?php  echo $this->Form->input('client_type', array('type'=>'select','options'=>['Customer'=>'Customer','Dealer'=>'Dealer'],'class'=>'form-control select_list','label' => 'I am a<sup>*</sup>','empty'=>'Select','required'=>true));?></div>
...
<div class="form-group padding_half col-md-6"><?php echo $this->Form->input('city',array('class'=>'form-control','label'=>'City<sup>*</sup>', 'required'=>true));?> </div><div class="clearfix"></div></div>
...
$("#tuning_ul li").click(function() {
    ...
    if(txt == 'Select'){
      ...
      $('#accessory_id').val(''); $('#accessory_id_q').val(''); $('#accessory_id_p').val(0);
      $('#tuning_pic_id').html(''); 
      ...
      if(qut > 0){  
        $('.selc_p_3').remove();
        $('#p_3').html(txt); $('#accessory_id').val(pid); $('#accessory_id_q').val(cat_b_q); $('#accessory_id_p').val(p_amt);
...
<li id="e0" pid="0" p_amt="0" data_img="" full_img=""><a href="javascript:void(0);">Select</a></li>
...
<?php if(isset($accessory) && !empty($accessory)){?>          
<div class="add-bx-sel"><div class="col-md-9 no-pad"><div class="add-bx-drop-dwn"><div class="new-pro-drdwn">
<button class="" type="button" id="p_3"> --- Armytron Accessory Selctions ---</button>
<ul class="" id="tuning_ul" style="display: none">

<li id="t0" pid="0" p_amt="0" data_img="" full_img=""><a href="javascript:void(0);" >Select</a></li>

<?php foreach ($accessory as $cList){
  $p = 'cdn/no_image_available.jpg';
  if(isset($cList['Library']['file_name']) && !empty($cList['Library']['file_name'])){ $p = 'cdn/'.$cList['Library']['folder']."/".$cList['Library']['file_name']; }
  $cImg = new_show_image($p,100,100,100,'ff',null);
  ?>
<li class="<?php if($cList['Product']['quantity'] == 0){ echo 'disable-itm'; }?>" qut="<?php echo $cList['Product']['quantity'];?>"  
...
<?php if(isset($gallery) && !empty($gallery)){
    foreach( $gallery as $gList){
        ...
        <a href="#">
		<img loading="lazy" alt="<?php echo $gList['Library']['alt'];?>"
		     src="<?php echo $sImg;?>"
...
<?php if( $data['ItemDetail']['url'] == 'mclaren-senna' ){ echo $this->element('pro/mc_laren_senna'); } ?>
...
<div class="slide_images">  
 ...
 <section class="text-section" id="txt_d">
   <div class="page-wrap">
     <div class="col-sm-12">
       <h4>ARMYTRIX VALVETRONIC:<br/> HOW IT WORKS - BRIEF OVERVIEW</h4>
...
<div class="buttons">
<a href="javascript:void(0);" onclick="btn_top()" class="back_top"><img loading="lazy" src="<?php echo SITEURL;?>v_4/images/backtotop.png" alt="" /></a>
<?php if( isset($restricted) && $restricted == 1 ){ ?><a href="javascript:void(0);" onclick="btn_qq()" class="btn-greens">Quote <img loading="lazy" src="<?php echo SITEURL;?>v_4/images/btn-png.png"></a>
<?php }else{?>
  ...
  <div class="modal-dialog modal-dialog-center auto-pop">
    ...
    <div class="modal-content">
      ...
      <div class="msg-suces-box">
        <p class="check-bx"><img loading="lazy" src="https://www.armytrix.com/flash_sale/images/check-icon.png" alt="">Your message has been successfully sent. We will get back to you by email within 24 - 48 hours.</p> 
    ...
    if (!isNaN(currentVal)) {
        if(type == 'minus') {
            ...
            if(currentVal > input.attr('min')) {
                ...
                else if( input.attr('id') == 'accessory_b_q' ){ $('#accessory_id_q').val(nv); }
            } 
