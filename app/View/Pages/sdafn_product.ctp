...
echo $this->element('pro/s5');
if($feature == 'ss'){
echo $this->element('pro/s6');
echo $this->element('pro/s7');
echo $this->element('pro/s8');
echo $this->element('pro/s9');
echo $this->element('pro/s10');

echo $this->element('pro/s12');
echo $this->element('pro/s13');
echo $this->element('pro/s14');
echo $this->element('pro/s15');
echo $this->element('pro/s16');
echo $this->element('pro/s11');
echo $this->element('pro/s17');
}
?>
...
$(document).ready(function(){
	...
	$('.ch_bg1').hover(function () {
	    ...
	    $('#sl_bg1').attr('style', 'background: url('+p+') no-repeat center center !important');
