...
<style>
    ...
    .bg-army-bx {
        ...
        min-height: 100vh;
        padding: 100px 0;
        background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(../v/youtube.jpg) no-repeat center center;
    ...
    #bg-welcome.sponser-form .sbmit-bttn input[type="button"] {
    ...
    #bg-welcome.sponser-form .sbmit-bttn input[type="button"]:hover {
