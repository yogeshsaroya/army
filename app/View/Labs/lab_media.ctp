...
.dropzone2{font-size: 20px;padding: 30px;}
</style>
...
<div class="col-md-12"> <div class="dropzone2"></div> </div>
<?php }else{?>
...
echo $this->Form->input('folder',array('class'=>'form-control','value'=>$f, 'placeholder'=>'Folder name (Not required)','label'=>false,'div'=>false));?>
</div>
<div class="form-group">
<label for="exampleInputFile">File input</label>
<?php echo $this->Form->file('img.',array('multiple'=>'multiple','accept'=>'image/x-png,image/gif,image/jpeg'));?>
</div>
</div>
<?php }?>
...
(function() {
    ...
    $(".dropzone2").dropzone({
    	url:'<?php echo SITEURL."lab/labs/new_up";?>',
        margin: 20,
