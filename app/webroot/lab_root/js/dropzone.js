...
(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'dropzone',
        defaults = {
            ...
            maxFileSize:            '25MB',                         //max file size ['bytes', 'KB', 'MB', 'GB', 'TB']
    ...
    Plugin.prototype.init = function () {
        ...
        if(this.options.clickToUpload){
            ...
            .append('<input type="file" accept="image/x-png,image/gif,image/jpeg" name="'+this.options.filesName+'" ' + multile + '/>').hide().
