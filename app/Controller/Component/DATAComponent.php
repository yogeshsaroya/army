...
class DATAComponent extends Component {
	...
	public function getRegion($name = null){
		if(!empty($name)){
			$tbl = ClassRegistry::init('CountryList');
			$data = $tbl->find('first',['conditions'=>['CountryList.iso2'=>strtoupper($name),'CountryList.status'=>1 ]] );
			return $data;
		}
    }
...
</head><body><table style="max-width: 820px; margin: auto"><thead><tr><td><table style="text-align: center;"><tr><td colspan="3" style="padding: 30px 15px;"><a href="'.SITEURL.'"><img src="'.SITEURL.'v/em/army-logo.png" alt="armytrix logo"></a></td></tr>
	            
<tr style="background: #333333">
<td style="padding: 0"><a href="'.SITEURL.'" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/home.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td>
<td style="padding: 0"><a href="'.SITEURL.'product-exhaust" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/exhaust.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td>
<td style="padding: 0"><a href="'.SITEURL.'contact" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/contact.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td>
</tr>
...
<p style="color: #00aa00;"> <a href="'.SITEURL.'order/success/'.$data['Order']['order_number'].'"> '.$data['Order']['order_number'].' </a> </p></div>
<div style="margin-bottom: 0;"><h4 style="font-size: 18px; text-transform: uppercase; font-weight: 500;">Order Date:</h4>
<p style="color: #00aa00;">'.date('m/d/Y',strtotime($data['Order']['created'])).' </p></div></td></tr></table></td></tr></table></td></tr><tr> <td style="padding: 40px 0"> <img src="'.SITEURL.'v/em/order-tx.png" alt="order details" style="max-width: 100%;" /> </td> </tr>
...
<h2 style="font-size: 28px; line-height: 1.2;">CAN  WE  HELP  ?</h2><h6 style="font-size: 18px; text-transform: uppercase; vertical-align: middle; font-weight: 500; line-height: 1.2;">Contact us <img src="'.SITEURL.'v/em/right-arrow.png" alt="arrow-images"></h6>
</div></a></td></tr></tbody><tfoot><tr style="background: #333;"><td style="color: #fff; font-weight: 500; font-size: 20px; text-align: center; padding: 15px 10px;"> © 2019 ARMYTRIX All Rights Reserved.</td></tr><tr><td style="font-weight: 300; font-size: 13px; text-align: center; font-style: italic; padding: 15px 10px;">Please do not reply to this email. If you need to contact  ARMYTRIX<br> with questions or concerns, please <a href="'.SITEURL.'customer-support" style="color: inherit; text-decoration: underline;">click here.</a></td></tr></tfoot></table><div style="display:none; white-space:nowrap; font:15px courier; color:#ffffff;">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</div></body></html>';
	    }
	    return $body;
	}
...
<h2 style="font-size: 28px; line-height: 1.2;">CAN  WE  HELP  ?</h2><h6 style="font-size: 18px; text-transform: uppercase; vertical-align: middle; font-weight: 500; line-height: 1.2;">Contact us <img src="'.SITEURL.'v/em/right-arrow.png" alt="arrow-images"></h6>
	...
	public function em_status() {
	        $body = '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=display-width, initial-scale=1.0, maximum-scale=1.0,">
                        ...
                        <tr style="background: #333333"><td style="padding: 0"><a href="'.SITEURL.'" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/home.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td><td style="padding: 0"><a href="'.SITEURL.'product-exhaust" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/exhaust.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td><td style="padding: 0"><a href="'.SITEURL.'contact" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/contact.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td></tr></table></td></tr></thead><tbody>
                        ...
                        <p style="margin-bottom: 15px;"><br>Armytrix Team</p></td></tr></table></td></tr><tr><td><a href="'.SITEURL.'contact" style="color: inherit;"><div style="text-align: center; padding-left: 80px; background: url('.SITEURL.'v/em/msg-icon.png) no-repeat left center; max-width: 250px; margin: 15px auto;">
                        <h2 style="font-size: 28px; line-height: 1.2;">CAN  WE  HELP  ?</h2><h6 style="font-size: 18px; text-transform: uppercase; vertical-align: middle; font-weight: 500; line-height: 1.2;">Contact us <img src="'.SITEURL.'v/em/right-arrow.png" alt="arrow-images"></h6>
                        </div></a></td></tr></tbody><tfoot><tr style="background: #333;"><td style="color: #fff; font-weight: 500; font-size: 20px; text-align: center; padding: 15px 10px;"> © 2019 ARMYTRIX All Rights Reserved.</td></tr><tr><td style="font-weight: 300; font-size: 13px; text-align: center; font-style: italic; padding: 15px 10px;">Please do not reply to this email. If you need to contact  ARMYTRIX<br> with questions or concerns, please <a href="'.SITEURL.'customer-support" style="color: inherit; text-decoration: underline;">click here.</a></td></tr></tfoot></table><div style="display:none; white-space:nowrap; font:15px courier; color:#ffffff;">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</div></body></html>';
	        return $body;
	}
	...
	public function email_structure() {
	    $body = '<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=display-width, initial-scale=1.0, maximum-scale=1.0,">
                        ...
                        <tr style="background: #333333"><td style="padding: 0"><a href="'.SITEURL.'" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/home.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td><td style="padding: 0"><a href="'.SITEURL.'product-exhaust" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/exhaust.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td><td style="padding: 0"><a href="'.SITEURL.'contact" style="color: #fff; text-transform: uppercase; text-decoration: none; font-size: 14px; font-weight: bold; padding: 2px 5px; display: block;"><img src="'.SITEURL.'v/em/contact.jpg" alt="Home" style="max-width: 150px; vertical-align: bottom;"></a></td></tr></table></td></tr></thead><tbody>
                        <tr><td><table><tr><td style="width: 60%; vertical-align: top; background: #f2f2f2">[EMAIL_BODY]</td></tr></table></td></tr><tr><td><a href="'.SITEURL.'contact" style="color: inherit;"><div style="text-align: center; padding-left: 80px; background: url('.SITEURL.'v/em/msg-icon.png) no-repeat left center; max-width: 250px; margin: 15px auto;">
                        <h2 style="font-size: 28px; line-height: 1.2;">CAN  WE  HELP  ?</h2><h6 style="font-size: 18px; text-transform: uppercase; vertical-align: middle; font-weight: 500; line-height: 1.2;">Contact us <img src="'.SITEURL.'v/em/right-arrow.png" alt="arrow-images"></h6>
                        </div></a></td></tr></tbody><tfoot><tr style="background: #333;"><td style="color: #fff; font-weight: 500; font-size: 20px; text-align: center; padding: 15px 10px;"> © 2019 ARMYTRIX All Rights Reserved.</td></tr><tr><td style="font-weight: 300; font-size: 13px; text-align: center; font-style: italic; padding: 15px 10px;">Please do not reply to this email. If you need to contact  ARMYTRIX<br> with questions or concerns, please <a href="'.SITEURL.'customer-support" style="color: inherit; text-decoration: underline;">click here.</a></td></tr></tfoot></table><div style="display:none; white-space:nowrap; font:15px courier; color:#ffffff;">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -</div></body></html>';
	    return $body;
	}
