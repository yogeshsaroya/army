<section id="page" class="html not-front not-logged-in no-sidebars page-node page-node- page-node-200 node-type-page i18n-en section-dealers">
   <div id="spacer"></div>
   <div class="clear"></div>
   <section class="main black">
      <!-- main start -->
                                 ...
                                 <div id="node-dealer-teaser-group-dealer" class="group-dealer field-group-div">
                                    <div class="field field-name-field-dealer-address field-type-text field-label-hidden">
                                       <div class="field-items">
                                          <div class="field-item even"><?php echo $list['OurDealer']['address']; ?></div>
                                       </div>
                                    </div>
                                    <div class="field field-name-field-dealer-location field-type-text field-label-hidden">
                                       <div class="field-items">
                                          <div class="field-item even"><?php echo $list['OurDealer']['email']; ?></div>
                                       </div>
                                    </div>
                                    <div class="field field-name-field-dealer-country field-type-text field-label-hidden">
                                       <div class="field-items">
                                          <div class="field-item even"><?php echo $list['OurDealer']['phone']; ?></div>
                                       </div>
                                    </div>
                                    <div class="field field-name-field-dealer-phone-number field-type-text field-label-hidden">
                                       <div class="field-items">
                                          <div class="field-item even"><?php echo $list['OurDealer']['country']; ?></div>
                                       </div>
                                    </div>
                                    <div class="field-type-text field-label-hidden">
                                       <div class="field-items">
                                          <div class="field-item even field field-name-field-geolocation"><?php echo $list['OurDealer']['lat'] . ", " . $list['OurDealer']['lang']; ?></div>
                                       </div>
                                    </div>
                                 </div>
                              </article>
...
<style>
   ...
   .page-node-2 .flexslider {
      margin: 0
   }

   .page-node-2 .flex-control-nav {
      display: none
   }

   .page-node-2 article.node {
      float: left
   }

   .page-node-2 .inner .field-name-body p {
      float: none;
      margin: 0 0 1em
   }
   ...
   .ie .commerce-add-to-cart .attribute-widgets .chzn-container-single .chzn-single span {
      padding: .15em 0 0
   }
   ...
   .ie #cart-sidecart-container {
      display: block
   }

   .ie .commerce-add-to-cart .attribute-widgets .form-type-select a.chzn-single {
   ...
   .page-node-200 .gm-style-iw h2 {
      color: #000
   }

   .page-node-200 .gm-style-iw p {
      color: #000
   }

   .page-node-200 .view-dealer-table {
      float: left;
      width: 100%;
      color: #000
   }

   .page-node-200 .view-dealer-table .node-dealer {
      float: left;
      width: 100%;
      padding: .75em;
      text-align: left
   ...
   .page-node-200 .view-dealer-table .group-dealer {
      float: left;
      width: 80%
   }

   .page-node-200 .view-dealer-table .node-title {
      float: left;
      width: 20%;
      font-weight: 600;
      font-size: 12px
   ...
   .page-node-200 .view-dealer-table .node-title a {
      text-transform: none;
      font-weight: 600;
      letter-spacing: 0
   }

   .page-node-200 .view-dealer-table .field-name-field-dealer-address {
      width: 40%
   }

   .page-node-200 .view-dealer-table .field-name-field-dealer-location {
      width: 25%
   }

   .page-node-200 .view-dealer-table .field-name-field-dealer-phone-number {
      text-align: right;
      width: 15%
   }

   .page-node-200 .view-dealer-table .field-name-field-dealer-country {
      text-align: center;
      width: 20%
   }

   .page-node-200 .view-dealer-table .field {
      float: left
   }

   .page-node-200 .view-dealer-table ul.links {
      display: none
   }

   .page-node-200 h3,
   .page-node-200 #spacer,
   .page-node-200 .field-name-field-geolocation,
   .page-node-200 .field-name-field-dealer-website {
      display: none
   }

   .node-type-dealer #dealer-location {
      float: left;
      width: 100%;
      height: 310px
   }

   .node-type-dealer article {
      float: left;
      width: 100%
   }
   ...
   .node-type-dealer .group-tableft1 {
      margin: -2.25em 0 0;
      float: left;
      width: 50%
   }

   .node-type-dealer .group-tabright1 {
      float: left;
      width: 50%;
      padding-left: 2em
   }

   .node-type-dealer .group-tabright1 .field {
      line-height: 1.5
   }

   .node-type-dealer .group-tabright1 .field a {
      text-decoration: underline;
      line-height: 1.5
   }

   .node-type-dealer h3,
   .node-type-dealer #spacer,
   .node-type-dealer .field-name-field-geolocation,
   .node-type-dealer .field-name-field-dealer-website {
      display: none
   }

   .hd-txt-arm #page-title {
      margin: .25em 0;
      font-size: 35px;
      text-align: left;
      margin: 20px 0
   ...
   #yellow-grad {
      ...
      float: left;
      background: green;
      background: -moz-linear-gradient(left, green 41%, #000 100%);
      background: -webkit-gradient(linear, left top, right top, color-stop(41%, green), color-stop(100%, #000));
      background: -webkit-linear-gradient(left, green 41%, #000 100%);
      background: -o-linear-gradient(left, green 41%, #000 100%);
      background: -ms-linear-gradient(left, green 41%, #000 100%);
      background: linear-gradient(to right, green 41%, #000 100%);
      filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffc61e', endColorstr='#000000', GradientType=1)
   }
   ...
   @media only screen and (max-width:480px) {
      ...
      .page-node-200 .field-name-field-dealer-address,
      .page-node-200 .field-name-field-dealer-location,
      .page-node-200 .field-name-field-dealer-phone-number {
         display: none
      }
