<?php
$img = 'https://res.cloudinary.com/armytrix/image/upload/fl_progressive,c_scale,q_auto,w_1920/v1652852783/product/armytrix-product-exhaust_c9uhwj.webp';
if (isset($IsMobile)) { $img = 'https://res.cloudinary.com/armytrix/image/upload/fl_progressive,c_scale,q_auto,w_720/v1652852841/product/phone-product-exhaust-portrait_vwpvge_yaauem.webp'; }
/*
