...
.bg-army-bx{min-height:600px;min-height:100vh;padding:100px 0;background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url(../v/sema.jpg) no-repeat center center;background-size:cover;letter-spacing:.3px}
...
.file-btn{border:2px dotted #fff;border-radius:0;padding:35px 10px;text-align:center;color:#fff!important}
.file-btn img{max-width:40px;padding-bottom:10px;display:block;margin:auto}
...
#bg-welcome.sponser-form .sbmit-bttn button{background:rgba(51,51,51,0.9);border:1px solid #0F0;padding:10px 35px;width:auto;font-family:big_noodle_titling!important;font-size:20px;border-radius:0;color:#fff;transition:all 500ms ease-in;-webkit-transition:all 500ms ease-in}
