...
<div class="box-header with-border"><h3 class="box-title">Cat-Back for <?php echo $i['ItemDetail']['name'];?></h3></div>

<div class="box-body" style="min-height: 100px;">
<div class="col-sm-12" id="">
<input type="hidden" id="pid" value="<?php echo $i['ItemDetail']['id'];?>">
<input type="hidden" id="type" value="<?php echo $type;?>">

<?php if(!empty($list)){ foreach ($list as $plist){ ?>

<div class="col-sm-12 catback"> <label>
<input type="checkbox" name="prod" class="flat-red pchkbox" value="<?php echo $plist['Product']['id'];?>">  <?php echo $plist['Product']['title']." (".$plist['Product']['part'].")";?></label></div>
...
<div id="pop_err"></div>
<br><br>
<div class="box-footer"><div class="alert alert-warning alert-dismissible"><?php echo @$type;?> not exist for this model </div></div>
<div class="box-footer">
