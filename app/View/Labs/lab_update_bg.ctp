...
<?php 
echo $this->Form->create('BgImage',array('type' => 'file','id'=>'proFrm'));
if(isset($e) && !empty($e)){
	$this->request->data['BgImage'] = $e['BgImage'];
}
...
<div class="box-body">
<div class="row">
<div class="col-md-12"><div class="form-group"><label for="">Link</label><?php echo $this->Form->input('page', array('label' => false,'readonly'=>true,  'error' => false, 'div' => false, 'class' => 'form-control input-md','required'=>true));?></div></div>
...
<img src="<?php 
if(isset($e['BgImage']['image']) && !empty($e['BgImage']['image']) ){
	echo  show_image('cdn/bg_image/',$e['BgImage']['image'],75,75,100,'ff',null);
