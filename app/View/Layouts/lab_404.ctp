...
<html>
  ...
  <!-- REQUIRED JS SCRIPTS -->
    ...
    <?php
        ...
        echo $this->Html->script(array('/lab_root/js/lab.min','/lab_root/js/jquery.magnific-popup.min','jquery.form.min')); ?>
    <script>
...
<div id="cover" ></div>  
	...
	echo $this->element('labs/menu'); ?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header"><h1>404 Error Page</h1></section>
          ...
          <div class="error-page">
            ...
            <div class="error-content">
              ...
              <p>
                ...
                Meanwhile, you may <a href="<?php echo SITEURL."lab/labs";?>">return to dashboard</a> or try using the search form.
              </p>
