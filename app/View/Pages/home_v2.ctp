...
<div id="v2_home">
            ...
            <div class="row d-flex loadBox" id="blogPost">
                <div class="col-md-4">
                    <div class="blogBox text-left">
                        <div class="imgWraps"><img src="<?php echo SITEURL;?>v2/home/ARMYTRIX.webp" loading="lazy" alt=""></div>
                        <h4> &nbsp </h4>
    ...
    <section class="fullWidthImageWrap pad60">
        <div class="fullWidthImages posRltv">
            <img src="<?php echo SITEURL;?>v2/home/shop_luileo.webp" loading="lazy" alt="full Images">
        ...
        <div class="fullWidthImages posRltv">
            <img src="<?php echo SITEURL;?>v2/home/performance.webp" loading="lazy" alt="full Images">
            <div class="contentWrap text-right bottom20">
        ...
        <div class="fullWidthImages posRltv">
            <img src="<?php echo SITEURL;?>v2/home/Sound__kit_snjzir.webp" loading="lazy" alt="full Images">
        ...
        <div class="fullWidthImages posRltv">
            <img src="<?php echo SITEURL;?>v2/home/test_evkqle.webp" loading="lazy" alt="full Images">
    ...
    <div class="auto-play-video">
        ...
        <div class="posRltv">
            ...
            <source src="<?php echo SITEURL;?>v2/home/armytrix-trailer.webm" type="video/webm">
                <source src="<?php echo SITEURL;?>v2/home/armytrix-trailer.mp4" type="video/mp4">
    ...
    <div class="fullWidthImages posRltv">
        <img src="<?php echo SITEURL;?>v2/home/main-end_liba2e.webp" loading="lazy" alt="">
...
if (n <= 3) { 
    ...
    var img='<?php echo SITEURL;?>v2/home/ARMYTRIX.webp' ; 
    if (typeof imgList !="undefined" && imgList !=null) { img=imgList.medium_large; } str +='<div class="col-sm-4"><div class="blogBox text-left"><div class="imgWraps"><img src="' + img + '" alt=""></div>' + '<h4>' + element['title'] + '</h4><p><b>' + element['published_on'] + ' </b>: ' + element['description'] + '</p>' + '<a href="' + element['url'] + '" class="wholeBoxLink"></a></div></div>' ; } n=n + 1; }); 
    $("#blogPost").html(str); $("#blogPost").removeClass('loadBox'); }); 

$('#home_slider').slick({ dots: true, infinite : true, autoplay: true, autoplaySpeed: 10000, infinite: true, speed: 500, fade: true, cssEase: 'linear' , adaptiveHeight: false }); }); 
