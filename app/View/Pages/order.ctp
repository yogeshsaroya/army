<?php if (isset($id) && $id == 'success') {
    ...
    <div class="invoice-page" id="order_st_page">
        <div class="container">
            <div class="customer-details sec-pad">
                <div class="row flex-box just-strch">
                    ...
                    <div class="col-sm-5 bg-gray pd_r_30">
                        ...
                        <div class="ordr-viw">
                            <h4>ORDER NUMBER:</h4>
                            <p><?php echo $data['Order']['order_number']; ?></p>
                        </div>
                        <div class="ordr-viw">
                            <h4>ORDER DATE:</h4>
                            <p><?php echo date('m/d/Y', strtotime($data['Order']['created'])); ?></p>
                        </div>
                        <div class="ordr-viw">
                            <h4>ORDER Status:</h4>
                            <p><?php if ($data['Order']['order_status_id'] == 0) {
                                    echo "In progress";
                                } elseif (isset($order_status[$data['Order']['order_status_id']])) {
                                    echo $order_status[$data['Order']['order_status_id']];
                                } ?></p>
                        </div>
                        ...
                        if (!empty($data['Order']['tracking']) && !empty($data['Order']['tracking_number'])) { ?>
                            <div class="ordr-viw">
                                ...
                                <p><?php echo $this->html->link($data['Order']['tracking_number'], $data['Order']['tracking']); ?></p>
                            </div>
                        <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="flex-box flex-unwrap invoice-total">
                            <div class="txt-bx">Subtotal (+)</div>
                            <div class="price-boxx">USD $<?php echo num_2($data['Order']['total_amount']); ?></div>
                        </div>
                        <div class="flex-box flex-unwrap invoice-total">
                            <div class="txt-bx">Shipping Cost (+)</div>
                        ...
                        <div class="flex-box flex-unwrap invoice-total">
                            ...
                            <div class="price-boxx">USD $<?php echo num_2($data['Order']['warranty_extension']); ?></div>
                        </div>
                        <div class="flex-box flex-unwrap invoice-total">
                            <div class="txt-bx"><b>Grand Total </b></div>
                            <div class="price-boxx">USD $<?php echo num_2($data['Order']['grand_total']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div class="row text-center">
                        <div class="col-sm-10 col-sm-offset-1">
                            <br><br>
                            <h2 style="color:#0fad00">Failed</h2>
