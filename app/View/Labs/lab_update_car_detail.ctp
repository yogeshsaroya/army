...
.img-phote-st .percent {
    ...
    background-position: center;Heading
    text-align: center;
    line-height: 100px;
    font-size: 25px;
    left: 50%;
}
#sortable_gal .ui-sortable-handle, #sortable_tt .ui-sortable-handle, #sortable_ss .ui-sortable-handle, #sortable .ui-sortable-handle { cursor: move; }
	
</style>
<div id="preloader_photo" class="img-phote-st" style="display: none"> <div class="percent">0%</div> </div>
<div class="content-wrapper">

<section class="content-header"><h1><a href="<?php if(!empty($data['ItemDetail']['url'])) {echo SITEURL."product/".$data['ItemDetail']['url'];} else{ echo "javascript:void(0);";}?>" target="_blank">
<?php 
...
<div class="col-md-2"><input type="button" class="btn btn-success" value="Slider For SS" onclick="add_slider(<?php echo $data['ItemDetail']['id'];?>,1);"></div>
<div class="col-md-2"><input type="button" class="btn btn-success" value="Slider For TT" onclick="add_slider(<?php echo $data['ItemDetail']['id'];?>,2);"></div>
...
<div class="box-header with-border">
<h3 class="box-title">Slider for SS</h3>
...
<div class="box box-default">
<div class="box-header with-border">
<h3 class="box-title">Slider for TT</h3>
<div class="box-tools pull-right">
<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
</div>
</div>
<div class="box-body" style="display: block;">
<div class="row" id="sortable_tt">
<?php 
if(isset($slidersTT) && !empty($slidersTT)){
	$n = 1;
	foreach ($slidersTT as $list){
		$main = show_image('cdn/'.$list['Library']['folder'],$list['Library']['file_name'],150,150,100,'cf',null);
	?>
<div class="col-sm-2 col-md-3 ui-sortable-handle" id="tt_<?php echo $list['Library']['id'];?>">
<div class="thumbnail">
<img src="<?php echo $main;?>" alt="" title="" class="margin">
 <div class="caption">
<p><a href="javascript:void(0);" onclick="del_pic(<?php echo $list['Library']['id'].",'".$data['ItemDetail']['id']."','slider_tt'";?>);" class="btn btn-primary" role="button">Delete</a> 
<?php if($n != 1){?>
<a href="javascript:void(0);" onclick="prim(<?php echo $list['Library']['id'].",'".$data['ItemDetail']['id']."','slider_tt'";?>);" class="btn btn-primary" role="button">Make Primary</a><?php }?> 
</p>
</div></div></div>
<?php $n++; } }?>
<div class="clearfix">
...
<div class="box box-info"><div class="box-header"><h3 class="box-title">Gallery</h3></div>
...
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'catback'){?>
<div class="active tab-pane">
<div class="box box-success">
<div class="box box-success"><div class="box-header"> <h3 class="box-title">Cat Back exhaust system</h3> 
<a class="btn btn-app" href="javascript:void(0);" onclick="add_cat(<?php echo $data['ItemDetail']['id'];?>,'cat-back')"><i class="fa fa-plus-square"></i> Add New Cat-Back </a></div>
<div class="box-body">
<div class="row">
...
if(!empty($cList)){ foreach ($cList as $aList){
	...
	$imgg  = new_show_image($full_path,100,100,100,'ff',null);?>
        <tr class="odd gradeX">
                        ...
                        <td><?php if($aList['Product']['type'] == 2){ echo "Cat-back";}elseif($aList['Product']['type'] == 3){ echo "Catalytic";}elseif($aList['Product']['type'] == 1){ echo "Tuning Box";} ?></td>
...
<?php }}else{?> <tr class="odd gradeX"><td colspan="7" class="center gnTxt">Empty</td></tr> <?php }?>	        
</tbody>
</table>
</div></div></div></div></div>
</div>
...
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'catalytic'){?>
<div class="active tab-pane">
<div class="box box-success">
<div class="box box-success"><div class="box-header"> <h3 class="box-title">Catalytic system</h3> 
<a class="btn btn-app" href="javascript:void(0);" onclick="add_cat(<?php echo $data['ItemDetail']['id'];?>,'catalytic')"><i class="fa fa-plus-square"></i> Add New Catalytic </a></div>
<div class="box-body">
<div class="row">
<div class="col-sm-12" id="lab_table">
<table class="table table-bordered table-hover dataTable" id="example2" role="grid" aria-describedby="example2_info">
...
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'accessory'){?>

<div class="active tab-pane">
<div class="box box-success">
<div class="box box-success"><div class="box-header"> <h3 class="box-title">Accessory</h3> 
<a class="btn btn-app" href="javascript:void(0);" onclick="add_cat(<?php echo $data['ItemDetail']['id'];?>,'accessory')"><i class="fa fa-plus-square"></i> Add New Accessory </a></div>
<div class="box-body">
<div class="row">
<div class="col-sm-12" id="lab_table">
<table class="table table-bordered table-hover dataTable" id="example2" role="grid" aria-describedby="example2_info">
...
if(!empty($cList)){ foreach ($cList as $aList){
	...
	?>
        <tr class="odd gradeX">
                        <td class="center gnTxt"><img src="<?php echo $imgg;?>" class="img-thumbnail" alt=""> </td>
                        <td><?php if($aList['Product']['type'] == 2){ echo "Cat-back";}elseif($aList['Product']['type'] == 3){ echo "Catalytic";}elseif($aList['Product']['type'] == 5){ echo "Accessory";} ?></td>
                        <td><?php echo $aList['Brand']['name']."/ ".$aList['Model']['name']."/ ".$aList['Motor']['name'];?></td>
                        <td><?php echo $aList['Product']['title'];?></td>
                        <td><?php echo $aList['Product']['part'];?></td>
                        <td><?php echo "$".$aList['Product']['price'];?></td>
...
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'shipping'){
...
$(document).ready(function(){
	...
	$( "#country_id" ).change(function() { window.location.href = '<?php echo SITEURL."lab/labs/update_car_detail/".$data['ItemDetail']['id']."?tab=shipping";?>&cid='+this.value; });
});
</script>      
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'manage_shipping'){?>
...
$(document).ready(function(){
	...
	$( "#country_id" ).change(function() { window.location.href = '<?php echo SITEURL."lab/labs/update_car_detail/".$data['ItemDetail']['id']."?tab=manage_shipping";?>&cid='+this.value; });
	$( "#state" ).change(function() { window.location.href = '<?php echo SITEURL."lab/labs/update_car_detail/".$data['ItemDetail']['id']."?tab=manage_shipping";?>&cid='+$("#country_id").val()+'&sid='+this.value; });
	
});
</script>  
<?php }
elseif(isset($q['tab']) && $q['tab'] == 'import_shipping'){?>
<div class="box box-info">
<div class="box-header with-border"><h3 class="box-title">Import shipping costs</h3></div>
...
<div class="box box-success">
<div class="box-header with-border"><h3 class="box-title">Export shipping cost</h3></div>
<div class="box-body"><div class="row"><div class="box-body"><div class="col-md-6">
<div class=" ">
<div id="text_err"></div>
...
<?php if(isset($allLangPage) && !empty($allLangPage)){
    ...
    foreach ($allLangPage as $pList){ ?>
                <tr>
                  <td><?php echo $num;?></td>
                  <td><?php
                  if(!empty($pList['ItemDetail']['url'])){ echo $this->html->link($langArr[$pList['ItemDetail']['language']],'/product/'.$pList['ItemDetail']['url'],array('target'=>'_blank'));}
                  else{ echo $langArr[$pList['ItemDetail']['language']]; }?></td>
                  ...
                  <td> <?php  
                  if($pList['ItemDetail']['status'] == 1){ echo $this->html->link('Active','/lab/labs/update_car_detail/'.$data['ItemDetail']['id'].'?lng_act='.$pList['ItemDetail']['id'],array('class' => 'text-green','confirm' => 'Do you want to inactive this page?')); }
                  elseif($pList['ItemDetail']['status'] == 0){ echo $this->html->link('Inactive','/lab/labs/update_car_detail/'.$data['ItemDetail']['id'].'?lng_act='.$pList['ItemDetail']['id'],array('class' => 'text-red','confirm' => 'Do you want to active this page?')); }
    	...
    	var cid = $('#carde_id').val();
    	 if( lang != "" && cid != "" ){
    		 ...
    		 $.ajax({type: 'POST',
		            ...
		            success: function(data) { $("#lang_err").html(data); $('#preloader').hide(); },
		            error: function(comment) { $("#lang_err").html(comment); $('#preloader').hide(); }});
    	 }
...
$("#sortable_gal").sortable({ opacity: 0.6, cursor: 'move', update: function() {
	var datastring = $(this).sortable("serialize");
	$(function() {
	$.ajax({type: 'POST', url: '<?php echo SITEURL;?>lab/labs/change_positions_pic/gal', data: datastring,
	success: function(data) { $("#ajax_req").html(data); }, error: function(comment) { } }); }); } });

$("#sortable_tt").sortable({ opacity: 0.6, cursor: 'move', update: function() {
	var datastring = $(this).sortable("serialize");
	$(function() {
	$.ajax({type: 'POST', url: '<?php echo SITEURL;?>lab/labs/change_positions_pic/tt', data: datastring,
	success: function(data) { $("#ajax_req").html(data); }, error: function(comment) { } }); }); } });
		

$("#sortable_ss").sortable({ opacity: 0.6, cursor: 'move', update: function() {
var datastring = $(this).sortable("serialize");
$(function() {
$.ajax({type: 'POST', url: '<?php echo SITEURL;?>lab/labs/change_positions_pic/ss', data: datastring,
success: function(data) { $("#ajax_req").html(data); }, error: function(comment) { } }); }); } });
