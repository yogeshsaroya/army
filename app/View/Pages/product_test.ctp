...
$(document).ready(function(){
	$("#p_111").click(function() {
		if ( $('#p_1').parent().hasClass('open') === true){ $('#p_1').parent().removeClass('open'); }
		else{ $('#p_1').parent().addClass('open'); }
});
...
<div class="dropdown">
<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" id="p_1">
...
<ul class="dropdown-menu" id="cat_back_ul">
...
<div class="add-bx-sel"><div class="col-md-9 no-pad"><div class="add-bx-drop-dwn"><div class="dropdown">
<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" id="p_2">--- Catalytic Converter Replacement Selections ---</button>
<ul class="dropdown-menu" id="ecu_ul">
...
<div class="add-bx-sel"><div class="col-md-9 no-pad"><div class="add-bx-drop-dwn"><div class="dropdown">
<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" id="p_3"> --- Armytron Tuning Box Selctions ---</button>
<ul class="dropdown-menu" id="tuning_ul">
