                ...
                <ul class="card-item">
                  ...
                  foreach ($all_pro as $list) {
                    ...
                    if ($list['Product']['type'] == 1) {
                      ...
                      if (isset($get_path)) {
                        $pImg = new_show_image('cdn/' . $get_path, 300, 150, 100, 'ff', null);
                      } else {
                        $pImg = new_show_image('cdn/no_image_available.jpg', 300, 150, 100, 'ff', null);
                      }
                    } else {
                      ...
                      <div class="col-md-6">
                          ...
                          <div class="item-price">
                            <h3><?php
                                if ($list['Product']['discount'] > 0) {
                                  echo $p_price = "USD <strike>$" . num_2($list['Product']['price']) . "</strike> <spam class='text-danger'>$" . num_2($amount) . "</spam>";
                                } else {
                                  echo $p_price = "USD $" . num_2($list['Product']['price']);
                                }
                                ?></h3>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="item-quantity">
                            <div class="center">
                              <?php if ($list['Product']['quantity'] > 0) { ?>
                                <div class="input-group"> <span class="input-group-btn">
                                    <button type="button" class="btn btn-default btn-number btn-snp" <?php if ($list['Cart']['quantity'] == 1) {
                                                                                                        echo 'disabled="disabled"';
                                                                                                      } ?> data-type="minus" data-field="quant[<?php echo $list['Cart']['id']; ?>]" cid="<?php echo $list['Cart']['id']; ?>"> <span class="glyphicon glyphicon-minus"></span> </button>
                                  </span>
                            ...
                            <?php if ($list['Product']['quantity'] > 0) {
                              echo '<div class="in-stock-pro"><h3>in stock</h3></div>';
                            } else {
                              echo '<div class="out-stock-pro"><h3>out of stock</h3></div>';
                            } ?>
                        ...
                        <div class="col-md-4">
                          <div class="item-total-price">
                            ...
                            <h3><?php if ($list['Product']['quantity'] > 0) {
                                  echo "USD $" . num_2($amount * $list['Cart']['quantity']);
                                } ?></h3>
                          </div>
                        </div>
                      </div>
            ...
            <div class="Note-section">
              <div class="col-md-12">
                ...
                <div class="note-content">
                  <textarea rows="4" cols="5" id="note" name="note" placeholder="If you have any question regarding to the custom value declaration of the goods you've purchased, please contact sales@armytrix.com or leave message in your order message board. Otherwise we will ship the goods value as it is."></textarea>
                </div>
              </div>
...
<script>
  ...
  $('.mneyyy').on('change', function() {
    $('#free_gift').val(this.value);
  });
