		...
		<ul class="socialMedia d-flex mt-5 align-items-center">
			<li>
				<a href="https://www.facebook.com/ARMYTRIX" target="blank">
					<i>
						<img src="<?php echo SITEURL; ?>v2/img/icon-Facebook.png" alt="" loading="lazy" width="100" height="100">
					</i>
					<span>Facebook</span>
				</a>
			</li>
			<li>
				<a href="https://www.youtube.com/user/ARMYTRIX" target="blank">
					<i>
						<img src="<?php echo SITEURL; ?>v2/img/icon-youtube.png" alt="" loading="lazy" width="100" height="100">
					</i>
					<span>Youtube</span>
				</a>
			</li>
			<li>
				<a href="https://www.instagram.com/armytrix_official" target="blank">
					<i>
						<img src="<?php echo SITEURL; ?>v2/img/icon-instagram.png" alt="" loading="lazy" width="100" height="100">
					</i>
					<span>Instagram</span>
				</a>
			</li>
			<li>
				<a href="https://apps.apple.com/us/app/armytrix/id990665141" target="blank">
					<i>
						<img src="<?php echo SITEURL; ?>v2/img/icon-downloadApp.png" alt="Download App" loading="lazy" width="100" height="100">
					</i>
					<span>Download App</span>
				</a>
			</li>
			<li class="d-flex justfy-content-end">
				<span><img src="https://res.cloudinary.com/armytrix/image/upload/w_200,c_fill,g_auto/v1650865451/home/paypal-logo_xs427c.png" alt="pay pal" loading="lazy" width="100" height="100"></span>
				<span><img src="https://res.cloudinary.com/armytrix/image/upload/w_200,c_fill,g_auto/v1650884862/home/fedex_blaw0r.webp" alt="fedEx" loading="lazy" width="100" height="100"></span>
				<span><img src="https://res.cloudinary.com/armytrix/image/upload/w_200,c_fill,g_auto/v1650884559/home/dhl-logo_uzvlhp.webp" alt="DHL" loading="lazy" width="100" height="100"></span>
			</li>
		</ul>
	</div>
</section>
