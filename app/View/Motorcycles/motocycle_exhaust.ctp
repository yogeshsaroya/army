<?php
$img = 'https://res.cloudinary.com/armytrix/image/upload/fl_progressive,c_scale,q_auto,w_1920/v1652760100/motorcycle/image/armytrix_xsr900-13_ymfngg.webp';
if (isset($IsMobile)) { $img = 'https://res.cloudinary.com/armytrix/image/upload/fl_progressive,c_scale,q_auto,w_720/v1652759120/motorcycle/image/RSV4_armytrix_exhaust-portrait_hlpxzl.webp'; }
/*
$img = SITEURL.'v2/motor_exhaust/armytrix_xsr900-13_ymfngg.webp';
if (isset($IsMobile)) { $img = SITEURL.'v2/motor_exhaust/RSV4_armytrix_exhaust-portrait_hlpxzl.webp'; }
*/


$b = $this->Lab->getMotorcycleMake();
?>
...
<div class="fullscreen_block_new fulScreen" id="tuning_box_page" style="min-height: 400px;">
  ...
  <div class="tuning-box">
    ...
    <div class="container" id="new-ui-add">
      <h2 class="mb-0">SELECT BRAND , MODEL / YEAR </h2>
      <h1>WEAPONIZED YOUR MOTORCYLE BY THE ARMYTRIX EXHAUST SYSTEMS</h1>
