...
<div class="col-md-12">
<br><br>
<iframe width="100%" height="500px" src="https://www.youtube.com/embed/<?php echo $data['ItemDetail']['vid'];?>?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
</div>
<?php }?>
