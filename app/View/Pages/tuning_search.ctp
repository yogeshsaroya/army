...
#new-ui-add h2{font-size:54px;font-weight:400;color:#fff;text-align:center;padding:0 10px;position:relative;z-index:99;text-shadow:0 0 40px #000;text-transform:uppercase}
#new-ui-add h2:before,#new-ui-add h2:after{}
#new-ui-add .tuningconfig{background:#212728;padding:30px}
#new-ui-add #frmTun{padding:0}
#new-ui-add select{-webkit-appearance:none;-moz-appearance:none;appearance:none;color:#fff;border:2px solid #fff!important;background-color:#212728!important;height:50px;margin:0;width:90%!important;background-image:url(/bootstrap_3_3_6/img/arrow-whte.png);background-position:right center;background-position:96% center;background-repeat:no-repeat;background-size:16px}
...
#new-ui-add .col-sm-4-nw,#frmTun .col-sm-4.text-left{width:32%}
#new-ui-add .col-sm-8-nw{width:68%}
...
.arw-rt::before{width:0;height:0;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:9px solid #fff;position:absolute;content:"";display:block;top:0;bottom:0;right:7px;margin:auto}
.col-sm-4-nw .arw-rt::before{right:-7px;border-left:9px solid #4AFF0C}
...
#new-ui-add h2{font-size:45px}
#new-ui-add .col-sm-8-nw{width:63%}
#new-ui-add .col-sm-4-nw,#frmTun .col-sm-4.text-left{width:37%}
#new-ui-add select{padding:0 22px 0 8px}
.arw-rt::before{right:5px}
.col-sm-4-nw .arw-rt::before{right:-5px;border-left:9px solid #4AFF0C}
}
...
.arw-rt::before{right:-5px}
.col-sm-4-nw .arw-rt::before{right:-8px;border-left:9px solid #4AFF0C}
#new-ui-add .col-sm-8-nw{width:100%;float:none}
#new-ui-add h2{font-size:33px}
...
#new-ui-add h2{font-size:30px;color:#fff;text-transform:uppercase;padding:0 15px;text-align:left}
#new-ui-add #frmTun #get_info img{max-width:20px;margin-top:-5px;width:100%}
...
<iframe id="home_bg_v" src="https://www.youtube.com/embed/Efjp-UVWhLo?controls=0&showinfo=0&autoplay=1&rel=0&vq=hd720&enablejsapi=1" allowfullscreen="" frameborder="0">
  ...
  <div class="tuning-box">
   ...
   <div class="container" id="new-ui-add"> 
    <h2>let performance do the talking</h2>
  ...
  <div class="clearfix"></div>                  
                ...
                <div class="col-sm-4  text-left tuningoptions no-pad col-sm-4-nw">                
                  ...
                  <div  class="nowrap col-sm-5 box-frm arw-rt"> 
                    <div class="td-bx "><input name="chiptuning" id="chiptuning" type="checkbox" value="Chiptuning"> <label for="chiptuning">Chiptuning</label></div>  
                    <div class="td-bx "><input name="catlesskit" id="catlesskit" type="checkbox" value="Catless Kit">
                    <label for="catlesskit">Catless kit</label></div></div>              
                 
                  <div  class="nowrap col-sm-7 box-frm"><!--<input name="sub" type="button" value="TUNE IT" class="btn btn-primary ps-ab" id="get_info">--> <button class="btn btn-primary ps-ab" id="get_info" name="sub" type="button" value="TUNE IT"><img src="<?php echo SITEURL;?>bootstrap_3_3_6/img/logo-icon.png" alt=""> TUNE IT</button></div>
