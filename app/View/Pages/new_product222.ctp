...
<br>
<div class="input-bx"><a href="<?php echo SITEURL."pages/contact_pop/".$data['ItemDetail']['id'];?>" class="btn btn-success ful-wd-btn GnRespopAjax_cls"><?php echo $this->Lab->getTeetLang(8,$lngtext);?></a> </div>
<?php  }else{?>
<div class="mail-bx-up"><?php echo $this->Lab->getTeetLang(7,$lngtext);?> <a href="mailto:sales@armytrix.com">sales@armytrix.com</a></div>        
        <div id="e_err"></div>    
...
<?php if( isset($exhaust) && !empty($exhaust) ){
    foreach ($exhaust as $k=>$eList){ ?>
        <img alt=""
        data-type="youtube"  src="https://i.ytimg.com/vi/<?php echo $eList;?>/mqdefault.jpg"
         data-image="https://i.ytimg.com/vi/<?php echo $eList;?>/sddefault.jpg"
         data-description=""
 ...
 <!--start 3 Modes One-key switch -->
   ...
   <div class="page-titles">
     <h1 class="head-arm">3 Modes One-key switch</h1>
</div>
...
<div class="clearfix"></div>          
 ...
 <section>
   <div class="remote-bg full_ht_bg">
        <h1 class="abst_head">Diamond-like crisp line design<br>
 Big mirror key brings gentle feel</h1>
</div>  
 </section> 
 <!--start Diamond-like crisp line design sec-->
...
<div class="buttons">
  <a href="#" class="btn-greens">Quote <img src="<?php echo SITEURL;?>v_4/images/btn-png.png"></a>
</div>
...
<!--- iphone-screen bg--->
 ...
 <h1 class="abst_head">Original OBDII dongle system<br>
     30% reduction in installation time</h1>
...
<div class="botm-lft abst_head clr-wht">
   <h1>Highest standard wind tunnel tes</h1>
   <p>Multiple tests and verification evoke beast<br/>
performance limit</p>
 </div>
...
Titanium alloy exhaust pipe<br> 
Make your car stronger and lighter
</h1>
</div>
<!--end hose-->
...
<video width="100%" height="auto" controls="disable"  class="_autoplay_vid" id="video_2" muted>
 ...
 <div class="botm-lft abst_head clr-wht">
   <h1>High quatity titanium alloy, lighter weight</h1>
   <p>more than 60% lighter than the exhaust device of orignal factory, car<br>
body weight reduced significantly.</p>
 </div>
...
<p>Exlend the life of exhaust system and maximize engine performance
</p>
 </div>
</div>
<!--end of hose-->
...
<div class="scan-bg full_ht_bg">
    <h1 class="abst_head vert_midl">Digital simulation manufacturing<br>
process only for perfect connection</h1>   
</div>
<!--End 3d-scanning-->
...
<!--start car engine sec-->
  <section class="car_engine full_ht_bg">
...
<?php }if($feature == 'ss'){?>
<!--start car engine sec-->
  <section class="car_engine full_ht_bg" style="background:url(<?php echo SITEURL;?>v_4/images/craftsmanship.jpg) no-repeat center center; padding:20px 15px;">
     <h1 class="abst_head">Precise craftmanship makes the exhaust<br>
     system a natural match with the underbody</h1> 
 </section>
<!--end car engine sec-->
...
<div class="botm-lft abst_head clr-wht">
   <h1>Aircraft-grade titanium alloy raw material</h1>
   <p>only high-purity titanium alloys can produce unique artwork-like colors</p>
 </div>
</div>
<!-- auto play video-->
...
<section class="glittering full_ht_bg" style="background:url(<?php echo SITEURL;?>v_4/images/glittering.jpg) no-repeat center center; padding:20px 15px;">
<h1 class="abst_head bottom-mid">Behind the glittering product is T.I.G. hand welding without welding slag</h1> </section>
...
<div class="lft_vert_mdl abst_head clr_blc">
   ...
   <p>Reduced weld bead for strengthened pipe wall structre and not &bsp; &bsp;easy to crack.</p>
 </div>  
</section>


<section class="car_engine full_ht_bg" >
<h1 class="abst_head">Precise craftmanship makes the exhaust<br>system a natural match with the underbody</h1> </section>

<section class="bg-slide">
             <div class="bg_img_shiny full_ht_bg" id="sl_bg" style=""></div>
...
<video width="100%" height="auto" controls="disable"  class="_autoplay_vid" muted id="video_5">
  ...
  <h1 class="abst_head midlle">Join the ARMY </h1>
</div>
<!-- auto play video--> 
