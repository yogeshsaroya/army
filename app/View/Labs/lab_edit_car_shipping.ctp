...
<section class="content-header"><h1>Edit Car Product Shipping Fee</h1></section>
...
<div class="form-group"><?php echo $this->Form->input('region',array('options'=>$regions, 'empty'=>' Select Region ', 'class'=>'form-control','required'=>true)); ?></div>

<div class="box-footer">
<div class="form-group ">

<input type="submit" class="btn btn-primary" value="Save">
<a href="<?php echo SITEURL;?>lab/labs/car_shipping" class="btn btn-default pull-right"> Back To List </a>
</div>
