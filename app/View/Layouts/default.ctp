...
<link href="https://fonts.googleapis.com/css2?family=Oswald:wght@400;700&family=Roboto&display=swap" rel="stylesheet" media="print" onload="this.media='all'" >
...
elseif ($this->params['controller'] == 'motorcycles') {
  if (in_array($this->params['action'], ['motocycle_exhaust'])) {
    $tran_header = 'yes';
  }
}
