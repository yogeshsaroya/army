		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<tr role="row">
                        <th><?php echo $this->Paginator->sort('NotificationTemplate.type', 'Type', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('NotificationTemplate.about', 'About', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('NotificationTemplate.message', 'message', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('NotificationTemplate.created', 'Created', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('NotificationTemplate.status', 'Status', array('escape' => false)); ?></th>
                        <th>Action</th>
                    </tr>
</thead>
<tbody id="table_rows">
