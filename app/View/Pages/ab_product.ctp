...
#kit_req input[type="text"], #kit_req input[type="email"], #kit_req input[type="password"], #kit_req textarea {
...
<link type="text/css" rel="stylesheet" href="<?php echo SITEURL;?>ui/css/new-pro-style.css" />
...
<div class="row_in"><div class="form-group padding_half col-md-6"><?php echo $this->Form->input('country',array('class'=>'form-control','label'=>'Country<sup>*</sup>', 'required'=>true));?></div>
...
<div class="clearfix"></div>          
 ...
 <section>
   <div class="full_ht_bg  bg-full remote-bg">   
    <div class="abst_head">
        <h1>A Touch Of Brilliance</h1>
        <h2 class="light_fnt">Modern minimalist design<br>
 Piano surface-like key brings high gloss finish</h2>
</div>  
 </section> 
 <!--start Diamond-like crisp line design sec-->
...
<div id="bg-full-sld">
    ...
    The mobile APP of ARMYTRIX can connect to the OBDII device via Bluetooth, and be used to as a remote controller to easily control valve switch and provide you with real-time monitoring of variuos values of your car, such as rotate speed, speed, fuel, etc. The rpm value in Auto mode can be set to open valves.</div>
                                <ul id="slideshow6_thumbs" class="desoslide-thumbs-horizontal list-inline ">
                                    <li>
                                            <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-8.jpg">
                                            <img src="<?php echo SITEURL;?>v_4/images/valves-control-hover.png" id="first-phone" alt=""   >
                                        </a><div class="icon-text">Valves Control</div>
                                    </li>
                                    <li >
                                        <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-9.jpg" >
                                            <img src="<?php echo SITEURL;?>ui/images/car-data.png" id="second-phone" alt=""   >
                                        </a><div class="icon-text">Car Data</div>
                                    </li>
                                    <li>
                                        <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-10.jpg" >
                                            <img src="<?php echo SITEURL;?>ui/images/settings.png"  alt=""  id="third-phone" >
                                        </a><div class="icon-text">Settings</div>
                                    </li>
                                    <li>
                                        <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-11.jpg" >
                                            <img src="<?php echo SITEURL;?>ui/images/error-code.png" alt=""  id="fourth-phone" >                                        </a><div class="icon-text">Trouble Code</div>
                                    </li>
                                    <li>
                                        <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-12.jpg" >
                                            <img src="<?php echo SITEURL;?>ui/images/diary.png" alt=""  id="fifth-phone" >
...
<!-- new design sections -->
<section class="img-full-bg ht-img">
    <div class="abst_head bold_light">
        <h1>Plug and Play</h1>
        <h2>Exclusive OBDII dongle module<br/>
            Reduce 30% of installation time<br/>
            No more complex wiring work</h2>
</div>
</section>

<section class="gray-bg text-center padd-100 img-vlu">
    <h1 class="clr-white">Unleash the ultra-high decibel output<br/>
for adrenaline-fuelled enjoyment</h1>
<img src="<?php echo SITEURL;?>ui/images/value-open.png"  alt=""/>
</section>  
...
<div class="top-lft abst_head clr-wht bold_light vido_1">
   <h1>High Quality Titanium Alloy, Lighter Weight</h1>
   <h2>More than 60% lighter than the exhaust device of original factory, car body weight
reduced significantly.</h2>
 </div>
...
<section class="whte-bg text-center img-sec-full">
    <h1>Downpipe with cutting-edge flexible pipe technology</h1>
    <h2>Protect exhaust pipes from breakage and facilitate cooling to maximize engine performance</h2>
<img src="<?php echo SITEURL;?>ui/images/Downpipe-png.png"  alt="" class="pos-absolut"/>
</section>  


<section class="gray-bg text-center padd-100 coating-bg-nw">
    <img src="<?php echo SITEURL;?>ui/images/bg-full.png"  alt=""/>
    <div class="abst-post-box">
    <h1 class="bg-font mx-500">Special rapid-cooling<br> ceramic coating<br>  reduces under-hood<br> temperature and <br>resistant to rust and<br> corrosion ( build-to-order )</h1>
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="img-skew">
                <img src="<?php echo SITEURL;?>ui/images/ceramic-coated-bg.png"  alt="" class="pos-absolut"/>
            </div>
            <div class="img-txt">
                <h3>Ceramic Coated Downpipe </h3>
                <p>Prevents metal fatigue from high temperature.</p>
            </div>
        </div>
    <!--end of col-->
    ...
    <div class="col-sm-6">
            <div class="img-skew">
                <img src="<?php echo SITEURL;?>ui/images/standard-downpipe.png"  alt="" class="pos-absolut"/>
            </div>
            <div class="img-txt">
                <h3>Standard Downpipe</h3>
                <p>Deteriorate under high temperature which leads to
pipe breakage.</p>
            </div>
        </div>
    <!--end of col-->
...
<section class="img-3d ht-img blue-txt">
    <div class="box-squre">
        <h1>3D scans car underbody for reverse<br/>
        engineering to collect all hardware data,<br/>
        result in rapid prototyping with high<br/>
        precision.
    </h1>
    </div>
    <img src="<?php echo SITEURL;?>ui/images/scane-3d.gif"  alt="" />
</section>  
...
<?php if($feature == 'ss'){?>
<section class="img-sec-crafted padd-100 text-center ht-img">
        <h1 class="clr-white">Meticulously crafted for precise fitment<br>
Quality is our pride of workmanship</h1>
</section>
...
<section class="Cristallization-img padd-50 text-center ht-img" id="ss-cristallization">
     <h1>Cristallization Of Technology And Art</h1>
     <p>Multiple refined mechanical polishing contributes to craftmanship level surface brightness.</p>
</section>

<section class="Labels-img text-center">
    <img src="<?php echo SITEURL;?>ui/images/shared-label-bg.png"  alt="" />
    <div class="abst-btm">
     <h1>Shred Labels Set New Standard</h1>
     <h2>High standard T.I.G. hand welding provides the strongest and <br> smoothest welds without welding slag.</h2>
    </div>
</section> 
...
<?php }
elseif($feature == 'titanium'){?>

<section class="img-sec-crafted padd-100 text-center ht-img"  id="tt-carfed">
        <h1 class="clr-white">Meticulously crafted for precise fitment<br>
Quality is our pride of workmanship</h1>
</section>
...
<!--end of photo gallery-->
<section class="Cristallization-img txt-left">
    <div class="abst-txt">
     <h1>Cristallization Of Technology And Art</h1>
     <p>Multiple refined mechanical polishing contributes to craftmanship level surface brightness.</p>
    </div> 
     <img src="<?php echo SITEURL;?>ui/images/cristallization_img.jpg"  alt="" />
</section>

<section class="Labels-img-tatanium text-center">
    <img src="<?php echo SITEURL;?>ui/images/shared-label-titanium.png"  alt="" />
    <div class="abst-btm">
     <h1>Shred  Labels,Set  New  Standard</h1>
     <h2>High standard T.I.G. handing welding provides the strongest and smoothest welds without weldingt slag.</h2>

     <ul class="icons-sec">
         <li class="actives">
             <span>Very fine</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon1.png"  alt=""/>
         </li>
         <li>
             <span>fine</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon2.png"  alt=""/>
         </li>
         <li>
             <span>flawless</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon3.png"  alt=""/>
         </li>
         <li>
             <span>Qualified</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon4.png"  alt=""/>
         </li>
         <li>
             <span>Failed</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon5.png"  alt=""/>
         </li>
         <li>
             <span>Defective</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon6.png"  alt=""/>
         </li>
         <li>
             <span>Micro-Rough</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon7.png"  alt=""/>
         </li>
         <li>
             <span>Rough</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon8.png"  alt=""/>
         </li>
         <li>
             <span>Very Rough</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon9.png"  alt=""/>
         </li>
         <li>
             <span>Very Rough</span>
             <img src="<?php echo SITEURL;?>ui/images/circle-icon10.png"  alt=""/>
         </li>
     </ul>
    </div>
</section>
...
<div class="hand_welding full-img">
    ...
    <section class="bg-slide noger-embellish">
        <div class="bg_img_shiny full_ht_bg" id="sl_bg" style="background: url(<?php echo SITEURL;?>v_4/images/Titanium-design-english-blue.jpg) no-repeat center center"></div>
       <div class="abst_head botm-txt"><h1>2 Personalized Tips Colors Embellish The Rear</h1></div>
       <ul class="controls noger-cont">
         <li bg-img="<?php echo SITEURL;?>v_4/images/Titanium-design-english-blue.jpg" class="ch_bg">
           <img src="<?php echo SITEURL;?>v_4/images/bg_icon_2.png" alt="" />
           <span>Unique Blue</span>
         </li>
         <li bg-img="<?php echo SITEURL;?>v_4/images/Titanium-design-english-black1.jpg" class="ch_bg">
           <img src="<?php echo SITEURL;?>v_4/images/bg_icon_3.png" alt="" />
           <span>Mysterious<br>Black</span>
         </li>
       </ul> 
