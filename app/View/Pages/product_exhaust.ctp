...
#new-ui-add h1{font-size:20px;font-weight:400;color:#fff;text-align:center;padding:0 10px;position:relative;z-index:99;text-shadow:0 0 40px #000;text-transform:uppercase}

#new-ui-add .tuningconfig{background:#212728;padding:40px 30px 0;}
#new-ui-add #frmTun{padding:0}
#new-ui-add select{-webkit-appearance:none;-moz-appearance:none;appearance:none;color:#fff;border:2px solid #fff!important;background-color:#212728!important;height:50px;margin:0;width:100%!important;}
...
#new-ui-add select,#new-ui-add label{font-weight:700;font-size:20px}
...
<iframe id="home_bg_v" style=" z-index: -99; width: 100%; height: autp" src="https://www.youtube.com/embed/TocQT9-xdeA?playlist=TocQT9-xdeA&controls=0&showinfo=0&autoplay=1&rel=0&loop=1&controls=0&vq=hd720&enablejsapi=1" allowfullscreen="" frameborder="0">
  ...
  <div class="clearfix"></div>                  
                ...
                <div class="col-sm-4  text-left tuningoptions no-pad col-sm-4-nw">    
                  ...
                  <img src="<?php echo SITEURL;?>bootstrap_3_3_6/img/logo-icon.png" alt=""> WEAPONIZED</button></div>
</div>
