    ...
    The mobile APP of ARMYTRIX can connect to the OBDII device via Bluetooth, and be used to as a remote controller to easily control valve switch and provide you with real-time monitoring of variuos values of your car, such as rotate speed, speed, fuel, etc. The rpm value in Auto mode can be set to open valves.</div>
                                <ul id="slideshow6_thumbs" class="desoslide-thumbs-horizontal list-inline ">
                                    <li>
                                            ...
                                            <img src="<?php echo SITEURL;?>ui/images/valves-control-hover.png" id="first-phone" alt=""   >
                                    ...
                                    <li>
                                        <a href="<?php echo SITEURL;?>ui/images/Stainless_steel-11.jpg" >
                                            <img src="<?php echo SITEURL;?>ui/images/error-code.png" alt=""  id="fourth-phone" >                                        </a><div class="icon-text">Error Code</div>
                                    </li>
                                    <li>
...
<section class="crytlztion full_ht_bg" style="background:url(<?php echo SITEURL;?>v_4/images/crystallization.jpg) no-repeat center center; padding:20px 15px;">
 <div class="top-mid abst_head clr-wht"> 
   <h1 class="mg-non-bot">Cristallization of technology and art</h1>
...
<section class="gray-bg text-center padd-100 coating-bg-nw">
    ...
    <h1 class="bg-font mx-500">Special rapid-cooling ceramic coating  reduces under-hood temperature and resistant to rust and corrosion ( build-to-order )</h1>
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="img-skew">
...
<section class="Cristallization-img padd-50 text-center ht-img">
...
$("#first-phone").attr('src', '<?php echo SITEURL; ?>v_4/images/car-dat.png');
