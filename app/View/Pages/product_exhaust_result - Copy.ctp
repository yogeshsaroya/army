<style>
.titanium a{ background: #ff3333 !important;}
...
#new-ui-add .col-sm-4-nw,#frmTun .col-sm-4.text-left{width:22%;padding:0 20px}
#new-ui-add .col-sm-8-nw{width:78%;padding:0}
.nowrap.col-sm-7.box-frm{width:100%;padding-left:0;padding-right:0}
...
#main_sec{margin:0}
.col-sm-4-nw .arw-rt::before{display:none}
}
...
.pos-abst{position:fixed;bottom:0;width:100%;padding:15px 5px 8px;height:auto;background:rgba(0,0,0,0.8);left:0;z-index:99}
.pos-abst #new-ui-add .tuningconfig{background:transparent;padding:10px 0}
.pos-abst #new-ui-add{max-width:740px;margin:0 auto}
.pos-abst #new-ui-add select{padding:0 15px}
...
.pos-abst #new-ui-add #frmTun #get_info{font-size:12px!important;line-height:40px!important;height:40px;padding:0 10px;color:#4AFF0C;float:none}
.pos-abst #new-ui-add #frmTun #get_info img{max-width:15px}
.pos-abst #new-ui-add select{font-size:12px!important;height:40px;padding:0 10px}
@media (min-width:768px) and (max-width:991px) {
.pos-abst #new-ui-add .col-sm-8-nw{width:75%;float:left}
.pos-abst #new-ui-add .col-sm-4-nw,#frmTun .col-sm-4.text-left{width:25%;margin:0 auto;float:left}
}
@media (max-width:767px) {
.pos-abst #new-ui-add #frmTun #get_info{margin-top:5px;background-color:#212728!important}
.pos-abst #new-ui-add select{margin-bottom:5px}
}
.product-exhausts{position:relative;padding:200px 0 30px}
.head-exast,.product-fliter-img-ex{display:inline-block}
.product-fliter-img-ex{max-width:120px;margin-left:30px}
.product-exhausts hr{border:0;border-bottom:2px solid #000;margin:20px 0 0}
.head-exast h1{font-size:30px;text-transform:uppercase;margin-top:10px}
.head-exast h1 span{font-family:"NimbusSanL-Bol";font-size:40px}
.product-fliter-img-ex img{vertical-align:middle;margin-top:-25px}
...
.featrs-txt{height:120px;text-align:left}
.featrs-txt h3{padding:0;margin:0 0 5px;font-size:18px;font-weight:600}
.exaust-cntnt{min-height:210px;position:relative}
.buton-bottm{text-align:left;position:absolute;bottom:0;width:100%;height:auto}
.rups{font-size:18px;color:#00a760;display:none}
.mx-wd{max-width:480px}
.mx-wd:after{clear:both;display:block;content:""}
.stainless_steel a{background:#2ECCFA!important;color:#000!important}
...
.buton-bottm ul.metal-type li a{padding:8px;color:#fff;background:#b4b4b4;display:block;text-align:center}
.add-cart-btn a{width:100%;font-size:16px!important;border-radius:0;background:#093 none repeat scroll 0 0;color:#fff;text-transform:uppercase;border:none;display:block;padding:8px;text-align:center}
.add-cart-btn a:hover{background:#444 none repeat scroll 0 0!important}
@media (max-width:991px) {
.mx-wd{max-width:500px}
.pro-exaust .col-sm-4{padding-left:0}
.pro-exaust .col-sm-8{padding:0}
.featrs-txt h3{padding:0;margin:0 0 5px;font-size:14px}
.featrs-txt p{font-size:12px;line-height:1.3}
.featrs-txt{height:100px}
.exaust-cntnt{min-height:180px}
#main_sec .metal-type,.metal-type a{list-style:none;font-size:12px}
#main_sec .buton-bottm ul.metal-type li a,.add-cart-btn a{padding:5px}
#main_sec .add-cart-btn a{font-size:14px!important}
.product-exhausts{padding:180px 0 30px}
}
@media (max-width:767px) {
...
.mx-wd{max-width:400px;margin:auto;padding:0 10px}
.featrs-txt{height:auto;margin-bottom:30px}
.exaust-cntnt{min-height:auto}
.buton-bottm{position:relative}
.img-pro{max-width:200px;margin:0 auto 30px}
.pos-abst #new-ui-add h2{margin-bottom:0;font-size:15px;color:#000;text-shadow:none}
.product-exhausts{padding:100px 0 150px}
.pos-abst #new-ui-add select{padding:0 10px}
.pos-abst #new-ui-add #frmTun #get_info{font-size:14px!important}
.head-exast h1,.head-exast h1 span{font-size:30px}
.product-fliter-img-ex{margin-left:20px}
.head-exast h1,.head-exast h1 span{font-size:25px}
.featrs-txt h3{font-size:16px}
.featrs-txt p{font-size:13px}
#main_sec .add-cart-btn a{font-size:18px!important}
#main_sec .buton-bottm ul.metal-type li a,.add-cart-btn a{padding:8px}
}
@media (max-width:580px) {
.product-fliter-img-ex img{vertical-align:top;margin-top:0;max-height:80px;width:auto}
.product-fliter-img-ex{margin-top:-100px;position:absolute;left:0;top:0;height:80px;max-width:100%;width:100%;margin-left:0}
.head-exast,.product-fliter-img-ex{display:block;text-align:center}
.product-exhausts hr{margin:10px 0 0}
}
@media (max-width:480px) {
.product-exhausts{padding:60px 0 100px}
}
</style>
       ...
       <div class="container-fmr ma-box">                  
        <div class="col-sm-12 no-pad col-sm-12-nw">          
                  ...
                  <select class="lable_txt arw-rt" id="brand" name="brand">
                    ...
                    <?php if(isset($b) && !empty($b)){ foreach ($b as $k=>$v){ echo '<option value="'.$k.'">'.$v.'</option>'; }} ?></select>
...
<div class="nowrap box-frm arw-rt">
                  <button class="btn btn-primary ps-ab" id="get_info" name="sub" type="button" value="TUNE IT">
                  <img src="<?php echo SITEURL;?>bootstrap_3_3_6/img/logo-icon.png" alt=""> TUNE IT</button>
</div></div> <?php */?>
...
<div class="container">
  <div class="col-sm-12 text-left">
    <div class="head-exast">
      <h1 id="title_d"><?php if(isset($cList['title']) && !empty($cList['title'])){ echo $cList['title'];}?></h1>
    </div>
    <div class="product-fliter-img-ex" id="car_pic"><?php if(isset($cList['image']) && !empty($cList['image'])){ echo $cList['image'];}?></div>
  </div>
  <div class="clearfix"></div>
</div>
<hr/>
