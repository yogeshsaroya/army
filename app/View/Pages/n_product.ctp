...
<style>
  *:focus {
  ...
  .body-button a.enquiry {
    background-color: #000;
    top: 230px;
    color: #fff
  }

  .body-button a.enquiry:hover {
    background-color: #000;
    color: #fff
  }
  ...
  a.popup-youtube img.youtube-icon {
    max-width: 50px;
    max-height: 50px;
    margin: auto;
    display: block;
  ...
  .color_green .icon-text,
  .color_green {
    color: #2ab464 !important
  }

  #kit_req input[type="text"],
  #kit_req input[type="email"],
  #kit_req input[type="paassword"],
  #kit_req textarea {
    border-width: 1.5px
  }
  ...
  button.btn.btn-green:last-child {
    margin-right: 0
  }
  ...
  .tab-boxes .nav>li>a:hover,
  .tab-boxes .nav>li.active>a {
  ...
  .in-side-box .col-sm-6 {
    padding: 0
  }

  .in-side-box .col-sm-6:first-child {
    padding-right: 5px
  }

  .in-side-box .col-sm-6:last-child {
    padding-left: 5px
  }
  ...
  #new-pro-page .tab-boxes .mid-slider-5,
  #new-pro-page .tab-boxes .image-glr-bx {
    margin: 0
  }

  #slideshow6_thumbs li {
    float: left;
    margin-right: 15px
  }
  ...
  .app-imgs.flt-box:last-child {
    padding-bottom: 50px;
    border-bottom: 0
  }

  #new-pro-page .pdf-dnld {
    display: block;
    list-style: none;
    padding: 30px 0;
    text-align: left;
  ...
  #new-pro-page .pdf-dnld:after {
    display: block;
    content: "";
    clear: both
  }

  #new-pro-page .pdf-dnld li {
    float: left;
    box-sizing: border-box;
    width: 20%;
    padding: 0 15px
  ...
  #new-pro-page .row.lang_bar.stickys {
    position: fixed;
    width: 100%;
    z-index: 999;
    top: 163px
  ...
  #new-pro-page .row.lang_bar label,
  #new-pro-page .row.lang_bar .input.select {
    display: inline-block;
    margin: 0 5px
  }
  ...
  #new-pro-page .row.lang_bar .arw-close {
    width: 30px;
    height: auto;
    top: 50%;
    right: 0;
  ...
  button.lang-div:hover,
  button.lang-div:focus,
  .open .btn-default {
    background: transparent !important
  }

  .btn-group:hover button.lang-div {
    color: #093
  }
  ...
  .lang_bar .dropdown-menu li {
    display: block
  }

  .lang_bar .dropdown-menu li a {
    text-align: left;
    font-size: 13px;
    cursor: pointer;
    text-transform: uppercase;
  ...
  .lang_bar .dropdown-menu li a:hover {
    background: #093
  }

  #main_sec .dropdown-menu li a {
    color: #fff !important
  }
  ...
  @media (max-width:991px) {
    ...
    .app-imgs.flt-box:last-child:before {
      display: none
    }
  ...
  @media (max-width:581px) {
    ...
    .container.hide,
    .container.mob-hide.cnter-line {
      display: block !important
    }

    .container.hide .col-xs-12,
    .lft-box .col-sm-6 {
      float: none;
      margin: 0 auto 50px;
      max-width: 400px;
    ...
    .container.hide .col-xs-12:last-child {
      margin-bottom: 0
    }
  ...
  @media (min-width:300px) and (max-width:768px) {
    ...
    #add-cart-bx .ful-wd-btn {
      background: #2ab464 !important;
    }
  }
  ...
  div#tab-data ul.nav.nav-tabs li:hover a:before,
  div#tab-data ul.nav.nav-tabs li:hover a:after,
  div#tab-data ul.nav.nav-tabs li.active a:before,
  div#tab-data ul.nav.nav-tabs li.active a:after {
...
<script>
  $(document).ready(function() {
    $(".icon-tb").click(function() {
      ...
      var $scrollTo = $('.product_v_list');
      $container.animate({
        scrollTop: $scrollTo.offset().top - $container.offset().top,
        scrollLeft: 0
      }, 300);
    });
    var a = $(".product_v_list").offset().top;
  ...
  jQuery(document).ready(function() {
    ...
    jQuery(window).scroll(function() {
      if (jQuery(this).scrollTop() > b) {
        jQuery(".back-to-top").fadeIn(a)
      } else {
        jQuery(".back-to-top").fadeOut(a)
      }
    });
    jQuery(".back-to-top").click(function(c) {
      c.preventDefault();
...
<?php */ ?>
  ...
  <div class="top-bg-4 top-set mt-top-50">
                      ...
                      <div id="sound_arm">
                        ...
                        <?php if (file_exists("army_sound/" . $data['ItemDetail']['url'] . ".mp3")) { ?>
                          ...
                          <style>
                            ...
                            .play_img {
                              background-image: url(../v_4/play.png);
                            ...
                            .pause_img {
                              background-image: url(../v_4/pause.png);
                              background-color: rgba(0, 0, 0, 0);
                              border: none;
                              height: 64px;
                              width: 64px;
                          ...
                          <audio id="myAudio">
                            <source src="<?php echo SITEURL . "army_sound/" . $data['ItemDetail']['url']; ?>.mp3" type="audio/mpeg"> Your browser does not support the audio element.
                          </audio>
                          <audio id="myAudio1">
                            <source src="<?php echo SITEURL . "army_sound/" . $data['ItemDetail']['url']; ?>_full.mp3" type="audio/mpeg"> Your browser does not support the audio element.
                          </audio>

                          <div class="col-sm-6" id="b1"> <button id="playAudio" type="button" class="play_img" aria-hidden="true"></button>
                            <p>Stock Exhaust</p>
                          </div>
                          <div class="col-sm-6" id="b2"> <button id="playAudio1" type="button" class="play_img" aria-hidden="true"></button>
                            <p>Armytrix Full Exhaust</p>
                          </div>
                          <div class="clearfix"></div>
                          ...
                          <script>
                            ...
                            document.getElementById("playAudio").addEventListener("click", function() {
                              audio1.pause();
                              b2.className = "play_img";
                              if (this.className == 'pause_img') {
                                this.className = "play_img";
                                audio.pause();
                              } else {
                                this.className = "pause_img";
                                audio.play();
                              }
                            });
                            document.getElementById("playAudio1").addEventListener("click", function() {
                              audio.pause();
                              b1.className = "play_img";
                              if (this.className == 'pause_img') {
                                this.className = "play_img";
                                audio1.pause();
                              } else {
...
<?php */ ?>
              ...
              <?php if (!isset($IsMobile)) { ?>
                <div class="line-bx-arm-5">
                  ...
                  <div class="line-arm"> <a> <span><?php echo $this->Lab->getTeetLang(1, $lngtext); ?></span> <i><span>+</span><?php echo $data['ItemDetail']['power']; ?><small><?php echo $this->Lab->getTeetLang(4, $lngtext); ?></small></i> </a>
                    ...
                    <a> <span><?php echo $this->Lab->getTeetLang(3, $lngtext); ?></span> <i><span>-</span><?php echo $data['ItemDetail']['weight']; ?><small><?php echo $this->Lab->getTeetLang(6, $lngtext); ?></small></i> </a>
                  </div>
                </div>
              <?php } ?>
            ...
            <div class="col-md-5">
              ...
              <div id="add-cart-bx">
                      ...
                      <div class="rows">
                        ...
                        <div class="row">
                          <div class="form-boxd">
                            ...
                            <div class="col-md-12">
                              <div class="row_in">
                                <div class="form-group padding_half col-md-6"><?php echo $this->Form->input('f_name', array('class' => 'form-control', 'label' => 'First Name<sup>*</sup>', 'required' => true)); ?></div>
                              ...
                              <div class="row_in">
                                <div class="form-group padding_half col-md-6"><?php echo $this->Form->input('country', array('options' => $this->Lab->country(), 'empty' => 'Select Country', 'class' => 'form-control select_list', 'label' => 'Country<sup>*</sup>', 'required' => true)); ?></div>
                ...
                <?php  } else { ?>
                  <p>Selected:</p>
                  <div id="selc"></div>
                  <div class="costing-num">
                    <h2 id="price">USD $0.00</h2>
                  </div>
                  <div class="clearfix"> </div>
                          ...
                          <div class="new-pro-drdwn">
                            ...
                            <ul class="" id="tuning_ul" style="display: none">
                              ...
                              <?php foreach ($accessory as $cList) {
                                ...
                                if (isset($cList['Library']['file_name']) && !empty($cList['Library']['file_name'])) {
                                  $p = 'cdn/' . $cList['Library']['folder'] . "/" . $cList['Library']['file_name'];
                                }
                                $cImg = new_show_image($p, 100, 100, 100, 'ff', null);
                              ?>
                                <li class="<?php if ($cList['Product']['quantity'] == 0) {
                                              echo 'disable-itm';
                                            } ?>" qut="<?php echo $cList['Product']['quantity']; ?>" id="<?php echo $cList['Product']['id']; ?>" pid="<?php echo $cList['Product']['id']; ?>" p_amt="<?php echo $cList['Product']['price']; ?>" data_img="<?php echo $cImg; ?>" full_img="<?php echo SITEURL . $p; ?>"><a href="javascript:void(0);"><?php
                                                                                                                                                                                                                                                                                                                                                                                                              if (!empty($cList['Product']['part'])) {
                                                                                                                                                                                                                                                                                                                                                                                                                echo "<div><h4>" . $cList['Product']['part'] . "</h4></div>";
                                                                                                                                                                                                                                                                                                                                                                                                              }
      ...
      <div id="gallery1">
        <?php if (!empty($data['Video'])) {
          foreach ($data['Video'] as $vlist) { ?>
            <img loading="lazy" alt="" data-type="youtube" src="https://i.ytimg.com/vi/<?php echo $vlist['video']; ?>/0.jpg" data-image="https://i.ytimg.com/vi/<?php echo $vlist['video']; ?>/0.jpg" data-description="" data-videoid="<?php echo $vlist['video']; ?>" style="display:none">
        <?php }
        } ?>
      </div>
    </section>
      ...
      <div id="gallery" style="display:none;">
        <?php if (isset($gallery) && !empty($gallery)) {
          foreach ($gallery as $gList) {
            ...
            <a href="#">
              <img loading="lazy" alt="<?php echo $gList['Library']['alt']; ?>" src="<?php echo $sImg; ?>" data-image="<?php echo SITEURL . $p; ?>" data-description="<?php echo $gList['Library']['title']; ?>" style="display:none">
            </a>
        <?php }
        } ?>
      </div>
    ...
    <?php if ($data['ItemDetail']['url'] == 'mclaren-senna') {
      echo $this->element('pro/mc_laren_senna');
    } ?>
...
<style>
  ...
  .auto-pop .modal-content {
    padding: 50px 40px 20px;
    text-align: left;
    background: #e5e4e4
  }

  .modal-dialog.auto-pop .close {
    font-size: 24px;
    height: 30px;
    width: 30px;
    background: #c7c6c6;
  ...
  .modal-dialog.auto-pop .close:hover {
    background: #ff7105;
    color: #fff
  }
...
<script>
  ...
  window['validatePhone'] = function(ph) {
  ...
  function pro() {
    ...
    if (f_name == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter first name</div>');
      $('#f_name').focus();
    } else if (l_name == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter last name</div>');
      $('#l_name').focus();
    } else if (!validateEmail(email_address)) {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter a valid email address.</div>');
      $('#eamil').focus();
    } else if (!validatePhone(Phone_number)) {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter a valid phone nuber.</div>');
      $('#phone').focus();
    } else if (city == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter city name.</div>');
      $('#city').focus();
    } else if (state == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter state name.</div>');
      $('#state').focus();
    } else if (country == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter country name.</div>');
      $('#country').focus();
    } else if (Zip_code == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter zip code</div>');
      $('#Zip_code').focus();
    } else if (subject == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please select subject</div>');
      $('#subject').focus();
    } else if (message == "") {
      $('#res').html('<div class="alert alert-danger" role="alert">Please enter message</div>');
      $('#message').focus();
    } else {
      $("#price_inq").ajaxForm({
        target: '#res',
...
<script>
  ...
  function inquiry() {
    $('html,body').animate({
      scrollTop: $("#doInquiry").offset().top - 150
    }, 'slow');
  ...
  */
  ...
  jQuery(document).ready(function() {
    jQuery("#gallery1").unitegallery({
      ...
      <?php if (isset($IsMobile)) {
      } else { ?> lightbox_arrows_offset: 130,
      <?php } ?>
