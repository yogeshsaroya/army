		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<tr role="row">
                        <th><?php echo $this->Paginator->sort('Category.name', 'Cateogry', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('Faq.title', 'Title', array('escape' => false)); ?></th>
                        <th><?php echo $this->Paginator->sort('Faq.created', 'Created', array('escape' => false)); ?></th>
                        <th>Delete</th>
                        <th>Action</th>
                    </tr>
</thead>
